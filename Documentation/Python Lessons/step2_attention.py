...
python3 step2_attention.py

============================================================
🌟 EXPLICAȚIE INTUITIVĂ: Ce face Self-Attention?
============================================================
...
--- Pas 1: Embeddings (din Step 1) ---
Tokens: ['Te', 'iubesc', 'dragă']
Embeddings shape: torch.Size([3, 8])

Primul embedding ('Te'):
tensor([ 1.9269,  1.4873,  0.9007, -2.1055,  0.6784, -1.2345, -0.0431, -1.6047])

--- Pas 2: Self-Attention Layer ---
Self-Attention Layer creat:
  Embed dim: 8
  Parametri Q: 64
  Parametri K: 64
  Parametri V: 64
...
'iubesc' acordă atenție:
  → 'Te': 0.365 ███████
  → 'iubesc': 0.303 ██████
  → 'dragă': 0.332 ██████

'dragă' acordă atenție:
  → 'Te': 0.355 ███████
  → 'iubesc': 0.324 ██████
  → 'dragă': 0.322 ██████
...
💡 Ce înseamnă attention weights?
   - Fiecare rând = un token se uită la ceilalți
   - Valori mari = mult context de acolo
   - Suma pe fiecare rând = 1.0 (probabilități)

'Te' - suma attention: 1.0000 ✓

'iubesc' - suma attention: 1.0000 ✓

'dragă' - suma attention: 1.0000 ✓

--- Comparație: Embedding → Attention Output ---

ÎNAINTE (embedding original 'iubesc'):
tensor([ 0.3559, -0.6866, -0.4934,  0.2415, -1.1109,  0.0915, -2.3169, -0.2168])

DUPĂ (cu context din 'Te' și 'dragă'):
tensor([ 0.2010,  0.1609,  0.4127,  0.1477,  0.2404, -0.0504,  0.3530,  0.1696],
       grad_fn=<SelectBackward0>)

💡 Output-ul e diferit pentru că acum 'iubesc' ÎNȚELEGE contextul!
   - A 'ascultat' ce spun 'Te' și 'dragă'
   - A integrat informația lor în înțelegerea sa

============================================================
SUCCESS! Self-Attention funcționează! ✓
============================================================

============================================================
🎯 NEXT STEP: Multi-Head Attention
   (Vom vedea cum să rulăm attention în paralel!)
============================================================
 ~/Documents/AI_Test                                                                     ✔ 